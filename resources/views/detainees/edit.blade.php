                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="datepicker_commitment_date" type="text" name="commitment_date" value="{{ $detainee->commitment_date ? $detainee->commitment_date->format('m/d/Y') : null }}" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
